...
import com.stylishfonts.fancyascii.facegenrator.databinding.ActAsciiFaceTextBinding;
...
public class ActivityAsciiFaceText extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        int id = v.getId();
        if (id == R.id.cardHappy) {
            intent.putExtra("AsciiFace", strArr);
            startActivity(intent);
        } else if (id == R.id.cardLove) {
